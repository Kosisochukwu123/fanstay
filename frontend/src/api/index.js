...
export const adminAPI = {
  ...
  reviewHost: (id, decision) =>
    api.put(`/admin/hosts/${id}/review`, { decision }),
  ...
  updateGiftCardProvider: (id, data) =>
    api.put(`/admin/giftcard-providers/${id}`, data),
  ...
  updateHero: (formData) =>
    api.put("/admin/settings/hero", formData, {
      headers: { "Content-Type": "multipart/form-data" },
    }),
  updateHomepageSections: (data) =>
    api.put("/admin/settings/homepage-sections", data),
  updateTestimonials: (testimonials) =>
    api.put("/admin/settings/testimonials", { testimonials }),
  updateInspiration: (inspirationCategories) =>
    api.put("/admin/settings/inspiration", { inspirationCategories }),
