...
export const paymentAPI = {
  createCryptoCharge: (bookingId) =>
    api.post("/payments/crypto/create-charge", { bookingId }),

  getCryptoStatus: (paymentId) =>
    api.get(`/payments/crypto/${paymentId}/status`),

  getGiftCardProviders: () => api.get("/payments/giftcard/providers"),

  submitGiftCard: (formData) =>
    api.post("/payments/giftcard/submit", formData, {
  ...
  submitHospitality: (formData) =>
    api.post("/payments/hospitality", formData, {
      headers: {
